...
let smokeOscColor = rnd_btw(1.1, 1.9);

voronoi(turbulence, 0.3, 0.1)
  .mult(
    osc(rnd_int(10, 50), smokeSpeed, smokeOscColor).rotate(rnd_btw(0, Math.PI))
  )
  .kaleid(fractalDepth)
  .modulate(noise(rnd_btw(1, 5), rnd_btw(0.1, 0.5)), rnd_btw(0.1, 0.5))
